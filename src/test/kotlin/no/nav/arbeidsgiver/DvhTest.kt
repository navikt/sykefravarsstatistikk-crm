...
class DvhTest : StringSpec() {
    ...
    init {
        ...
        "Should getSyfraStats fra apiet" {
            ...
            potensielleDagsverk[0].potensielleDagsverk shouldBe 0
            potensielleDagsverk[0].muligeDagsverk shouldBe 509
            potensielleDagsverk[0].tapteDagsverk shouldBe 23
        }
        ...
        "Should extractStatsNaering" {
            ...
            if (naringStat != null) {
                ...
                naringStat.sumTapteDagsverk shouldBe 46.0
                naringStat.sumMuligeDagsverk shouldBe 588.492
            }
        }
    }
